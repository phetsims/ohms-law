...
<a href="https://phet.colorado.edu/sims/html/ohms-law/latest/ohms-law_en.html" target="_blank">Click here to run "Ohm's
Law".</a>
...
(5) Open in the browser: `http://localhost/ohms-law/ohms-law_en.html` (You will probably need to modify this URL based
...
(3) Open in the browser: `http://localhost/ohms-law/build/adapted-from-phet/ohms-law_en_adapted-from-phet.html` (You
