Ohm's Law
=============
"Ohm's Law" is an educational simulation in HTML5, by <a href="https://phet.colorado.edu/" target="_blank">PhET Interactive Simulations</a>
...
<a href="https://phet.colorado.edu/sims/html/ohms-law/latest/ohms-law_en.html" target="_blank">Click here to run "Ohm's Law".</a>
...
(5) Open in the browser: `http://localhost/ohms-law/ohms-law_en.html` (You will probably need to modify this URL based on your HTTP port and relative path.)
...
(3) Open in the browser: `http://localhost/ohms-law/build/adapted-from-phet/ohms-law_en_adapted-from-phet.html` (You will probably need to modify this URL based on your HTTP port and relative path.)
