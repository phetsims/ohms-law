...
(5) Open in the browser: `http://localhost/ohms-law/ohms-law_en.html` (You will probably need to modify this
...
(3) Open in the
browser: `http://localhost/ohms-law/build/adapted-from-phet/ohms-law_en_adapted-from-phet.html` (You will
